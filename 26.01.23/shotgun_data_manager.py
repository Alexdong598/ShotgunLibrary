...
# Define dependent modules for reloading
DEPENDENT_MODULE_NAMES = ["sg_register", "env"]
...
def execute():
    ...
    for module_name in DEPENDENT_MODULE_NAMES:
        if module_name in sys.modules:
            try: importlib.reload(sys.modules[module_name])
            except: pass
    try: importlib.reload(sys.modules[__name__])
    except: pass
